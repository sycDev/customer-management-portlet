 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link customerManagementService.service.impl.CustomerLocalServiceImpl}.
 * </p>
 *
 * @author Sin Yi
 * @see customerManagementService.service.impl.CustomerLocalServiceImpl
 * @generated
 */
public abstract class CustomerLocalServiceBaseImpl
	...
	public void addServicesCustomer(long serviceId, long customerId) {
		servicesPersistence.addCustomer(serviceId, customerId);
	}
	...
	public void addServicesCustomer(long serviceId, Customer customer) {
		servicesPersistence.addCustomer(serviceId, customer);
	}
	...
	public void addServicesCustomers(long serviceId, long[] customerIds) {
		servicesPersistence.addCustomers(serviceId, customerIds);
	}
	...
	public void addServicesCustomers(long serviceId, List<Customer> customers) {
		servicesPersistence.addCustomers(serviceId, customers);
	}
	...
	public void clearServicesCustomers(long serviceId) {
		servicesPersistence.clearCustomers(serviceId);
	}
	...
	public void deleteServicesCustomer(long serviceId, long customerId) {
		servicesPersistence.removeCustomer(serviceId, customerId);
	}
	...
	public void deleteServicesCustomer(long serviceId, Customer customer) {
		servicesPersistence.removeCustomer(serviceId, customer);
	}
	...
	public void deleteServicesCustomers(long serviceId, long[] customerIds) {
		servicesPersistence.removeCustomers(serviceId, customerIds);
	}
	...
	public void deleteServicesCustomers(
		...
		servicesPersistence.removeCustomers(serviceId, customers);
	}
	...
	public long[] getServicesPrimaryKeys(long customerId) {
		return customerPersistence.getServicesPrimaryKeys(customerId);
	}
	...
	public List<Customer> getServicesCustomers(long serviceId) {
		return customerPersistence.getServicesCustomers(serviceId);
	}
	...
	public List<Customer> getServicesCustomers(
		...
		return customerPersistence.getServicesCustomers(serviceId, start, end);
	}
	...
	public List<Customer> getServicesCustomers(
		...
		return customerPersistence.getServicesCustomers(
	...
	public int getServicesCustomersCount(long serviceId) {
		return servicesPersistence.getCustomersSize(serviceId);
	}
	...
	public boolean hasServicesCustomer(long serviceId, long customerId) {
		return servicesPersistence.containsCustomer(serviceId, customerId);
	}
	...
	public boolean hasServicesCustomers(long serviceId) {
		return servicesPersistence.containsCustomers(serviceId);
	}
	...
	public void setServicesCustomers(long serviceId, long[] customerIds) {
		servicesPersistence.setCustomers(serviceId, customerIds);
	}
