...
import customerManagementService.model.CustomerModel;
...
/**
 * The base model implementation for the Customer service. Represents a row in the &quot;CM_Customer&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class CustomerModelImpl
	 ...
	 */
	public static final String TABLE_NAME = "CM_Customer";

	public static final Object[][] TABLE_COLUMNS = {
		{"customerId", Types.BIGINT}, {"customerName", Types.VARCHAR},
		{"customerIdentityNo", Types.VARCHAR}, {"customerEmail", Types.VARCHAR},
		{"customerAddress", Types.VARCHAR},
		{"customerContactNo", Types.VARCHAR}, {"groupId", Types.BIGINT},
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("customerIdentityNo", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("customerEmail", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("customerAddress", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("customerContactNo", Types.VARCHAR);
	...
	public static final String TABLE_SQL_CREATE =
		"create table CM_Customer (customerId LONG not null primary key,customerName VARCHAR(75) null,customerIdentityNo VARCHAR(75) null,customerEmail VARCHAR(75) null,customerAddress STRING null,customerContactNo VARCHAR(75) null,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null)";

	public static final String TABLE_SQL_DROP = "drop table CM_Customer";

	public static final String ORDER_BY_JPQL =
		" ORDER BY customer.customerId ASC";

	public static final String ORDER_BY_SQL =
		" ORDER BY CM_Customer.customerId ASC";
	 ...
	 */
	@Deprecated
	public static final long CUSTOMERNAME_COLUMN_BITMASK = 1L;
	...
	static {
		...
		attributeGetterFunctions.put(
			"customerIdentityNo", Customer::getCustomerIdentityNo);
		attributeSetterBiConsumers.put(
			"customerIdentityNo",
			(BiConsumer<Customer, String>)Customer::setCustomerIdentityNo);
		attributeGetterFunctions.put(
		...
		attributeGetterFunctions.put(
			"customerContactNo", Customer::getCustomerContactNo);
		attributeSetterBiConsumers.put(
			"customerContactNo",
			(BiConsumer<Customer, String>)Customer::setCustomerContactNo);
	...
	public String getOriginalCustomerName() {
		return getColumnOriginalValue("customerName");
	}

	@Override
	public String getCustomerIdentityNo() {
		if (_customerIdentityNo == null) {
			return "";
		}
		else {
			return _customerIdentityNo;
		}
	}
	...
	public void setCustomerIdentityNo(String customerIdentityNo) {
		...
		_customerIdentityNo = customerIdentityNo;
	}
	...
	public void setCustomerContactNo(String customerContactNo) {
		...
		_customerContactNo = customerContactNo;
	}
	...
	public Object clone() {
		...
		customerImpl.setCustomerIdentityNo(getCustomerIdentityNo());
		customerImpl.setCustomerEmail(getCustomerEmail());
		customerImpl.setCustomerAddress(getCustomerAddress());
		customerImpl.setCustomerContactNo(getCustomerContactNo());
	...
	public Customer cloneWithOriginalValues() {
		...
		customerImpl.setCustomerIdentityNo(
			this.<String>getColumnOriginalValue("customerIdentityNo"));
		...
		customerImpl.setCustomerContactNo(
			this.<String>getColumnOriginalValue("customerContactNo"));
	...
	public CacheModel<Customer> toCacheModel() {
		...
		customerCacheModel.customerIdentityNo = getCustomerIdentityNo();

		String customerIdentityNo = customerCacheModel.customerIdentityNo;

		if ((customerIdentityNo != null) &&
			(customerIdentityNo.length() == 0)) {

			customerCacheModel.customerIdentityNo = null;
		}
		...
		customerCacheModel.customerContactNo = getCustomerContactNo();

		String customerContactNo = customerCacheModel.customerContactNo;

		if ((customerContactNo != null) && (customerContactNo.length() == 0)) {
			customerCacheModel.customerContactNo = null;
		}
	...
	private String _customerIdentityNo;
	...
	private void _setColumnOriginalValues() {
		...
		_columnOriginalValues.put("customerIdentityNo", _customerIdentityNo);
		_columnOriginalValues.put("customerEmail", _customerEmail);
		_columnOriginalValues.put("customerAddress", _customerAddress);
		_columnOriginalValues.put("customerContactNo", _customerContactNo);
	...
	static {
		...
		columnBitmasks.put("customerName", 2L);

		columnBitmasks.put("customerIdentityNo", 4L);

		columnBitmasks.put("customerEmail", 8L);

		columnBitmasks.put("customerAddress", 16L);

		columnBitmasks.put("customerContactNo", 32L);
