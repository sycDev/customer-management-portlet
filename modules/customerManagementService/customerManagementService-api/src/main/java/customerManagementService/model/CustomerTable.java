...
/**
 * The table class for the &quot;CM_Customer&quot; database table.
 *
 * @author Sin Yi
 * @see Customer
 * @generated
...
public class CustomerTable extends BaseTable<CustomerTable> {
	...
	public final Column<CustomerTable, String> customerIdentityNo =
		createColumn(
			"customerIdentityNo", String.class, Types.VARCHAR,
			Column.FLAG_DEFAULT);
	...
	public final Column<CustomerTable, String> customerContactNo = createColumn(
		"customerContactNo", String.class, Types.VARCHAR, Column.FLAG_DEFAULT);
	...
	private CustomerTable() {
		super("CM_Customer", CustomerTable::new);
	}
